...
Profissão: ".v($v5["pessoal"]["profissao"] ?? $b4["DADOS"]["CBO"])."
...
RG: ".v($d["rg"] ?? $b4["DADOS"]["RG"])."
Título eleitor: ".v($d["voter_id"] ?? $b4["DADOS"]["TITULO_ELEITOR"])."
...
$itens = ["Biscoitos","Refrigerante","Café","Arroz","Sabonete","Chocolate","Leite","Pão"];
